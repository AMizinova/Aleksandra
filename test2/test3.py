...
"""
a = 'Μизинοва Αлекϲандра Αндреевна'
""" Задание №1
...
print('№1 ' + str(fio == ['Μизинοва', 'Αлекϲандра', 'Αндреевна']))
...
""" Задание №4
Получите в переменной 'res' строку из третьей буквы вашей Фамилии
---------------начало блока редактирования----------------"""
...
"""------------ конец блока редактирования----------------"""
print('№7 ' + str(surname_list == ['Μ', 'и', 'з', 'и', 'н', 'ο', 'в', 'а']))
...
"""------------ конец блока редактирования----------------"""
print('№8 ' + str(surname_tuple == ('Μ', 'и', 'з', 'и', 'н', 'ο', 'в', 'а')))
...
"""------------ конец блока редактирования----------------"""
print('№10 ' + str(res == [(0, 'Μ'), (1, 'и'), (2, 'з'), (3, 'и'), (4, 'н'), (5, 'ο'), (6, 'в'), (7, 'а')]))
...
"""------------ конец блока редактирования----------------"""
print('№11 ' + str(res == ['а', 'в', 'ο', 'н', 'и', 'з', 'и', 'Μ']))
...
"""------------ конец блока редактирования----------------"""
print('№13 ' + str(res == ['Μ', 'и', 'и', 'н', 'ο', 'в', 'а']))
